...
// ==========================CSS section End===========================//
    ...
    return (
        <div >
            <div style={{ display: 'flex', justifyContent: 'space-between', marginRight: '-90px' }}>
                <Link to='/addbatches' className='btn btn-outline-dark btn-md mb-1 mt-3'>
                ...
                <Table sx={{ minWidth: 500 }} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align="center">BatchCode</StyledTableCell>
                        ...
                        {batches
                            ...
                            .map((data, index) => {
                                return <StyledTableRow key={data.id}>
                                    ...
                                    <StyledTableCell align="center">{data.batchcode}</StyledTableCell>
