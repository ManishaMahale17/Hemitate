...
const BranchList = ({ getBranches, BranchList }) => {
  ...
  return (
    <div>
      <div className='mt-3' style={{ display: 'flex', justifyContent: 'space-between', marginRight: '-90px' }}>

        <Link to='/branchform' className='btn btn-outline-primary btn-md mb-1 mt-3'>
          < AddOutlinedIcon />Add Branch Details
        </Link>
        <TextField
          label="Search"
          variant="outlined"
      ...
      <TableContainer component={Paper} className='mt-5'>
        <Table sm={{ minwidth: 700 }} aria-label="customized table" >
          <TableHead>
            <TableRow>
