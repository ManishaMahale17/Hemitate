...
import { deleteCourseSuccess } from "../Action";
...
const Course = ({ getCourses, Course }) => {
  ...
  return (
    <div>
      ...
      >
        <Link to="/courseform" className="btn btn-outline-info mt-4 ms-4">
          <AddCardIcon />
          Add
        </Link>
                  ...
                  <StyledTableRow key={index}>
                    ...
                    <StyledTableCell align="center">
                      <Link
                        ...
                        className="btn btn-outline-success btn small ms-2"
                      >
                      ...
                      <button
                        ...
                        type="button"
                        className="btn btn-outline-primary btn-small ms-2"
                      >
                        <RemoveRedEyeIcon />
                      </button>
