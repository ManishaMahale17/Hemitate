...
export function getHolidays(){
    return (dispatch)=>{
        ...
        .then((response)=>{
            ...
            dispatch(getHolidayError(error.response))
        });
    }
}
export function getHolidayRequest(payload){
    return({
...
export function getDeleteHolidaySuccess() {
    return {
...
export function addHoliday(holidayData) {
    return (dispatch) => {
        ...
        Post(urls.holidays, holidayData)
            ...
            .catch((error) => {
                dispatch(addHolidayError(error.response));
            });
    };
}
...
export function editHoliday(editHolidayData, id) {
    return (dispatch) => {
