...
import TrainerLeaveForm from "./pages/TrainerLeaves/container/TrainerLeaveForm";
import TrainerLeaves from "./pages/TrainerLeaves/container/TrainerLeaves";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/dashboard" element={<DashBoard />}>
              ...
              <Route path="trainerLeaveForm" element={<TrainerLeaveForm/>}></Route>
              ...
              <Route path="trainerleaves" element={<TrainerLeaves/>}/>
         ...
         {/* Holiday Routing */}
           ...
           <Route path="leave" element={<Leaves/>}></Route>
            <Route path="/leaveForm" element={<LeaveForm/>}></Route>
                 ...
                 {/* Trainer Leaves Routing */}
           <Route path="trainerleave" element={<TrainerLeaves/>}></Route>
            <Route path="/trainerLeaveForm" element={<TrainerLeaveForm/>}></Route>
